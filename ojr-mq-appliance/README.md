...
**Download the installation package from [OJR releases](https://github.com/liurui-1/ojr/releases/):**
```script
wget https://github.com/liurui-1/ojr/releases/download/xxx/ojr-mq-appliance-xxx.tar
```
...
**Get the source code from [github.com](https://github.com/liurui-1/ojr.git).**
```script
git clone https://github.com/liurui-1/ojr.git
cd ojr-xxx
```
